...
if( $mode != "" )
{
	if( $mode == "edit" || $mode == "add" )
	{
		...
		$template->assign_vars(array(
			"WORD" => htmlspecialchars_wrapped($word_info['word'], ENT_COMPAT, 'utf-8'),
			"REPLACEMENT" => htmlspecialchars_wrapped($word_info['replacement'], ENT_COMPAT, 'utf-8'),
...
else
{
	...
	for($i = 0; $i < $word_count; $i++)
	{
		...
		$template->assign_block_vars("words", array(
			"ROW_COLOR" => "#" . $row_color,
			"ROW_CLASS" => $row_class,
			"WORD" => htmlspecialchars_wrapped($word, ENT_COMPAT, 'utf-8'),
			"REPLACEMENT" => htmlspecialchars_wrapped($replacement, ENT_COMPAT, 'utf-8'),
