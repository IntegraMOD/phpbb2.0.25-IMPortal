...
<link rel="stylesheet" href="../templates/fisubSilver/css/stylesheet.css" type="text/css">
...
<body>
  ...
  <div class="forumline mt-3">
  <div class="row pt-2">
    <div class="col ctr">
      <a href="http://www.integramod.com" target="_blank"><img class="img-fluid " src="../images/logo/logo_phpBB.gif" border="0" alt="" vspace="1" /></a>
    </div>
  </div>
...
<div align="center">
<br />
<font class="copyright"><strong><U>phpBB2.0.25+ CHMOD script</U> Version 2.1.0</strong><br><br><em>Original script started by <strong>Fubie</strong>
...
<a href="http://www.integramod.com" target="_blank"><img src="../images/logo/phpbbintegraMOD.jpg" width="470" height="62" border="0"></a><br>
</div>
  </div>
  </div>
</body>
...
function chmodsettingsbox()  // Pre-install or after install?  Install directory detection
{
     ...
     if (file_exists($install) !== false) {
        $preinstall = 1;
        $detection .= "<div align='center'><font  class='mainmenu'><strong>install</strong></font><strong> detected</strong></div>";
     }
     if ($preinstall) {
       ...
       $detection .= "<div align='center'><strong>No</strong> <font class='mainmenu'>install</font><strong> directories detected</strong></div><hr>";
    ...
    $detection .= "<div align='center' class='postdetails'>Files and Directories have already been set conform to <strong>After-install</strong> settings</div>";
     ...
     if (file_exists($configfile) !== false) {
      ...
      //$configfilesize .= size($configfile, 6, 'gb');
        $detection .= "<hr><div align='center'><font class='mainmenu'><strong>$configfile</strong></font></div><div align='center' class='postdetails'>Size: ".$configfilesize." kb</div>";
        if ($configfilesize == 0) {
       ...
       $detection .= "<hr><div align='center'><strong>Error:</strong></div><div align='center'>No <font class='foundercolor'><strong>config.php</strong></font><strong> found</strong></div>";
     }
...
// --------------------------------------------------------------------------------------------------------------------------------
       ...
       if ( chmod($testfile, octdec($testmod)) == false ) {
          ...
          $testcontents = "<div class='mainmenu' align='center'><strong>PHP CHMOD <br><u>not</u><br> permitted by server</strong></div><hr>";
...
// --------------------------------------------------------------------------------------------------------------------------------
         ...
         ini_set ( 'error_reporting', E_ALL ^ E_NOTICE );
           ...
           $testcontents = "<div class='mainmenu' align='center'><strong>PHP CHMOD permitted by server</strong></div><hr>";
...
<table width="510" align="center" cellpadding="3" cellspacing="0" bgcolor="#006699">
  <tr>
    <td><table width="100%" cellpadding="3" cellspacing="0" bgcolor="#FF0000">
        <tr>
          <td align="center"><strong><font color="#FFFF00" size="3" face="Arial, Helvetica, sans-serif">Wrong FTP settings</font></strong></td>
        </tr>
        <tr>
               ...
               <table align="center" cellpadding="3" cellspacing="0" bgcolor="#3399CC">
                 <tr>
                   <td><table cellpadding="4" cellspacing="0" bgcolor="#00CCFF">
                       <form method="post" action="<?php echo $PHP_SELF;?>">
                       <tr>
                         <td colspan="2" bgcolor="#3399CC"><font face="Geneva, Arial, Helvetica, sans-serif" color="#CBEBFE" size="3"><strong>FTP SETTINGS</strong></font></td>
                         <td width="1" rowspan="3" bgcolor="#3399CC"></td>
                         <td colspan="2" bgcolor="#3399CC"><font face="Geneva, Arial, Helvetica, sans-serif" color="#CBEBFE" size="3"><strong>FTP LOGIN</strong></font></td>
...
// -  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  -
  ...
  $filename = "<font color='#6666CC' size='3'>$path</font>";
...
$testfile = '../includes/def_qbar.php';
$testmod = 666;
...
<table width="100%" cellpadding="3" cellspacing="1" border="0" class="forumline">
		<tr>
			<th><?php echo $lang['Welcome_install'];?></th>
		</tr>
		<tr>
...
//      echo "Selecting after-install Chmod settings for this process<br><br>";
   ...
   if ($processcall == 'info') {
      ...
      $contents = "<div align='center'>Both <font class='mainmenu'>Linux</font> and <font class='admin'>Windows</font> come in desktop and server editions.<br>";
      $contents .= "<br><font class='admin'>There is no such thing as CHMOD in WINDOWS.</font><br>CHMOD only works with <font class='mainmenu'>Apache on a Unix, Linux</font> system.<br>";
      $contents .= "<br><font size='24' class='mainmenu'>I can only recommend using a LINUX-server!</font></div>";

      $contents .= "<br><br><font class='maintitle' color='#663399'>Why not on Windows-servers?</font><br>";
      $contents .= "<br><font class='admin'>Windows can't distinguish between user/group/other </font><font class='mainmenu'>the way it is done in UNIX-filesystems</font><font class='admin'>. Therefore, they always match the <u>individual</u> permissions.</font>";
      ...
      $contents .= "<br>The <font class='mainmenu'>UNIX/Linux commands</font> that are offered are <u>far more powerful</u> than those offered by <font class='admin'>MS Windows</font>.<br>There are more options in <font class='mainmenu'>UNIX/Linux</font>.<br>For example,  switches are case sensitive, so you can have even more switches than in <font class='admin'>MS Windows</font>, as <u><font class='admin'>MS Windows</font> is not case sensitive</u>.<br>This is just a minor comparison and contrast between <font class='mainmenu'>UNIX/Linux</font> and <font class='admin'>MS Windows</font>.<br>";

      $contents .= "<br><br><font class='maintitle' color='#663399'>Why recommend Linux as server?</font><br>";
      $contents .= "<br>There are several cases where a flaw in <b>Apache</b> poses <u>little or no danger on <font class='mainmenu'>Linux</font></u>, but is <u>a serious vulnerability on <font class='admin'>Windows</font></u>. The reverse is rarely, if ever, the case.<br>";
      $contents .= "Should the overall security ranking of <font class='admin'>Windows</font> suffer because it is more adversely affected than <font class='mainmenu'>Linux</font> when using software that is most commonly associated with <font class='mainmenu'>Linux</font>?<br>";
      ...
      $contents .= "<br><u><font class='mainmenu'>Linux</font> does not rely on or encourage local use of a graphical interface</u>, in part because it is an <b>unnecessary waste of resources</b> to run a graphical desktop at the server, and in part <b>because it increases security risks at the server</b>.";
      ...
      $contents .= "<br>If you administer a <font class='mainmenu'>Linux server</font> remotely from a desktop user account, a browser flaw exposes only the remote desktop user account to security holes, not the server. This is why <u>a browser security hole in <font class='admin'>Windows Server 2003</font> is potentially more serious</u> than a browser security hole in Red Hat Enterprise Server AS.<br>";

      $contents .= "<br><br><font class='maintitle' color='#663399'>Advantages of Linux.</font><br>";
      $contents .= "<br><b>Speed, efficiency and reliability</b> are all <u>increased</u> by running a server instance of <font class='mainmenu'>Linux without a GUI</font>, something that server versions of <u><font class='admin'>Windows</font> can not do</u>.<br>";
      $contents .= "<br>";
      $contents .= "<br>";
      ...
      $contents .= "<tr><td class='mainmenu'><b>777</b>: </td><td>all can read / write / execute the file.</td></tr>";
      $contents .= "<tr><td class='mainmenu'><b>755</b>: </td><td>owner can do all, group / others can read / execute.</td></tr>";
      $contents .= "<tr><td class='mainmenu'><b>644</b>: </td><td>owner can read / write, group / others can read only.</td></tr>";
      $contents .= "</table>";
      $contents .= "<br><a href='http://www.analysisandsolutions.com/code/chmod.htm' target='_blank'>chmod Tutorial</a><br>";
      $contents .= "<br>Using the numbering scheme, the chmod command has three number places,<br>for example <font class='mainmenu'>744</font>, representing the three user types.<br>The first number on the left side is for '<font class='mainmenu'><b>user</b></font>', the middle one is for '<font class='mainmenu'><b>group</b></font>' and the right hand one for '<font class='mainmenu'><b>other</b></font>'. Now, here's what each number does:<br>";
      $contents .= "<table align='center'>";
      $contents .= "<tr><td class='mainmenu'><b>0</b></td><td> --- </td><td>no access</td></tr>";
      $contents .= "<tr><td class='mainmenu'><b>1</b></td><td> --x </td><td>execute</td></tr>";
      $contents .= "<tr><td class='mainmenu'><b>2</b></td><td> -w- </td><td>write</td></tr>";
      $contents .= "<tr><td class='mainmenu'><b>3</b></td><td> -wx </td><td>write and execute</td></tr>";
      $contents .= "<tr><td class='mainmenu'><b>4</b></td><td> r-- </td><td>read</td></tr>";
      $contents .= "<tr><td class='mainmenu'><b>5</b></td><td> r-x </td><td>read and execute</td></tr>";
      $contents .= "<tr><td class='mainmenu'><b>6</b></td><td> rw- </td><td>read and write</td></tr>";
      $contents .= "<tr><td class='mainmenu'><b>7</b></td><td> rwx </td><td>read write execute (full access)</td></tr>";
      $contents .= "</table>";
      box($title, $contents);
...
$system = "<div align='center'><font class='mainmenu'><strong>Linux</strong></font><strong> detected</strong></div><hr><div align='center' class='postdetails'><strong>permissions need to be set on this system</strong></div>";
