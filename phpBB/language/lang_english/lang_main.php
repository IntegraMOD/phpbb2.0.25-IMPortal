...
$lang['fa_Forum'] = '<i class="fa fa-list" aria-hidden="true"></i>&nbsp;Forums';
$lang['fa_Admin'] = '<i class="fa fa-cog" aria-hidden="true"></i>&nbsp;ACP';
$lang['fa_Register'] = '<i class="fa fa-check-circle-o" aria-hidden="true"></i>&nbsp;Register';
$lang['fa_Profile'] = '<i class="fa fa-user" aria-hidden="true"></i>&nbsp;Profile';
$lang['fa_Search'] = '<i class="fa fa-search" aria-hidden="true"></i>&nbsp;Search';
$lang['fa_Memberlist'] = '<i class="fa fa-list-ul" aria-hidden="true"></i>&nbsp;Memberlist';
$lang['fa_FAQ'] = '<i class="fa fa-question-circle" aria-hidden="true"></i>&nbsp;FAQ';
$lang['fa_Usergroups'] = '<i class="fa fa-users" aria-hidden="true"></i>&nbsp;Usergroups';
$lang['fa_Login'] = '<i class="fa fa-sign-in" aria-hidden="true"></i>&nbsp;Log In';
$lang['fa_Logout'] = '<i class="fa fa-sign-out" aria-hidden="true"></i>&nbsp;Log Out';
$lang['fa_Private_Messages'] = '<i class="fa fa-pencil-square-o" aria-hidden="true"></i>&nbsp;Private Messages';
$lang['fa_Login_check_pm'] = '<i class="fa fa-pencil-square-o" aria-hidden="true"></i>&nbsp;Log in to check your private messages';
$lang['fa_New_pms'] = '<i class="fa fa-pencil-square-o" aria-hidden="true"></i>&nbsp;You have %d new messages'; // You have 2 new messages
$lang['fa_New_pm'] = '<i class="fa fa-pencil-square-o" aria-hidden="true"></i>&nbsp;You have %d new message'; // You have 1 new message
$lang['fa_No_new_pm'] = '<i class="fa fa-pencil-square-o" aria-hidden="true"></i>&nbsp;You have no new messages';
$lang['fa_Unread_pms'] = '<i class="fa fa-pencil-square-o" aria-hidden="true"></i>&nbsp;You have %d unread messages';
$lang['fa_Unread_pm'] = '<i class="fa fa-pencil-square-o" aria-hidden="true"></i>&nbsp;You have %d unread message';
$lang['fa_No_unread_pm'] = '<i class="fa fa-pencil-square-o" aria-hidden="true"></i>&nbsp;You have no unread messages';
...
// language buttons
//
$lang['button_pm_new'] = 'New<span class="bld hov">PM</span>';
$lang['button_pm_reply'] = 'Send<span class="bld hov">Reply</span>';
$lang['button_topic_locked'] = '<span class="bld hov">Locked</span>';
$lang['button_topic_new'] = 'New<span class="bld hov">Topic</span>';
$lang['button_topic_reply'] = 'Post<span class="bld hov">Reply</span>';
