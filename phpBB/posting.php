...
while( list($var, $param) = @each($params) )
{
	...
	{
		$$var = ( !empty($_POST[$param]) ) ? htmlspecialchars_wrapped($_POST[$param], ENT_COMPAT, 'utf-8') : htmlspecialchars_wrapped($_GET[$param], ENT_COMPAT, 'utf-8');
	}
	else
	{
		$$var = '';
...
{
	$username = ( !empty($_POST['username']) ) ? htmlspecialchars_wrapped(trim(stripslashes($_POST['username'])), ENT_COMPAT, 'utf-8') : '';
	$subject = ( !empty($_POST['subject']) ) ? htmlspecialchars_wrapped(trim(stripslashes($_POST['subject'])), ENT_COMPAT, 'utf-8') : '';
	$message = ( !empty($_POST['message']) ) ? htmlspecialchars_wrapped(trim(stripslashes($_POST['message'])), ENT_COMPAT, 'utf-8') : '';

	$poll_title = ( !empty($_POST['poll_title']) ) ? htmlspecialchars_wrapped(trim(stripslashes($_POST['poll_title'])), ENT_COMPAT, 'utf-8') : '';
	...
	if ( !empty($_POST['poll_option_text']) )
	{
		while( list($option_id, $option_text) = @each($_POST['poll_option_text']) )
		{
			...
			{
				$poll_options[intval($option_id)] = htmlspecialchars_wrapped(trim(stripslashes($option_text)), ENT_COMPAT, 'utf-8');
			}
		}
	}
	...
	{
		$poll_options[] = htmlspecialchars_wrapped(trim(stripslashes($_POST['add_poll_option_text'])), ENT_COMPAT, 'utf-8');
	}
