...
<div class="container-fluid forumline">
  <div class="row th">
	<div class="col bd pt-1 text-left">{catrow.tablehead.L_FORUM}</div>
	<div class="col-1 bd pt-1 px-1 mw1 text-center">{L_TOPICS}</div>
	<div class="col-1 bd pt-1 px-1 mw1 text-center">{L_POSTS}</div>
...
<!-- BEGIN forumrow -->
  <div class="row row2 align-right" onMouseOver="this.className='row row1'" onMouseOut="this.className='row row2'">
 	<!-- BEGIN inc -->
	<div class="col-1 bd row2 mw2 mx-auto pb-4 {catrow.forumrow.inc.INC_CLASS}"><img src="{SPACER}" alt="" width="26" height="0" /></div>
	<!-- END inc -->
	<div  class="col-1 bd row2 mw2 mx-auto pb-4 {catrow.forumrow.INC_CLASS} pt-4"><img src="{catrow.forumrow.FORUM_FOLDER_IMG}" width="26" height="25" alt="{catrow.forumrow.L_FORUM_FOLDER_ALT}" title="{catrow.forumrow.L_FORUM_FOLDER_ALT}" /></div>
