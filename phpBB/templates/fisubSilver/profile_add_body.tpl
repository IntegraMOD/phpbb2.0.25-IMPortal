  ...
  <div class="row forumline">
	...
	<!-- BEGIN switch_confirm -->
      ...
      <div class="row gen">
        ...
        <div class="col-8 row2 py-1"><input type="text" class="post" style="width: 200px" name="confirm_code" size="6" maxlength="6" value="" /></div>
      </div>
	<!-- END switch_confirm -->
