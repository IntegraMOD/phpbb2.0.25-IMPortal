...
<div class="container-fluid pl-0">
  <div class="row">
    <div class="col-md"><span class="nowrap"><a href="{U_INDEX}" class="nav">{L_INDEX}</a></span></div>
  </div>
</div>
...
<div class="container-fluid forumline">
  <div class="row th thH">
    ...
    <div class="col-md-3 thTop text-left">{L_USERNAME}</div>
    <div class="col-md-1 thTop text-left">{L_POSTS}</div>
  ...
  <div class="row th thH gen">
    ...
    <div class="col-md-3 row1 text-left"><a href="{U_MOD_VIEWPROFILE}">{MOD_USERNAME}</a></div>
    <div class="col-md-1 row1 text-left">{MOD_POSTS}</div>
  ...
  <div class="row thH gen">
    ...
    <div class="col-md-3 {member_row.ROW_CLASS} text-left"><a href="{member_row.U_VIEWPROFILE}" class="gen">{member_row.USERNAME}</a></div>
    <div class="col-md-1 {member_row.ROW_CLASS} text-left">{member_row.POSTS}</div>
  ...
  <!-- BEGIN switch_mod_option -->
  <div class="row"> 
    <div class="col catBottom thH cattitle text-right"><input type="submit" name="remove" value="{L_REMOVE_SELECTED}" class="mainoption" /></div>
  </div>
  <!-- END switch_mod_option -->
</div>
...
<div class="container-fluid px-0">
  <div class="row">
    ...
    <div class="col-md-4 py-1" align="right"><span class="gensmall">{S_TIMEZONE}</span><br /><span class="nav">{PAGINATION}</span></div>
  </div>
</div>
