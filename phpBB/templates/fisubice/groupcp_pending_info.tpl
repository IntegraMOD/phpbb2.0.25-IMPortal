...
<div class="container-fluid forumline">
  ...
  <div class="row thH gen">
    ...
    <div class="col-md-3 {pending_members_row.ROW_CLASS} text-left"><a href="{pending_members_row.U_VIEWPROFILE}" class="gen">{pending_members_row.USERNAME}</a></div>
    <div class="col-md-1 {pending_members_row.ROW_CLASS} text-left">{pending_members_row.POSTS}</div>
  ...
  <div class="row th thH gen">
    <div class="col-md cat text-right">
	  <span class="cattitle"> 
