...
<div class="col-sm-3 m-0 px-0" id="left_block" style="display: block;">
        	...
        	<!-- END border -->
         	">
        	  ...
        	  <!-- Shown when the title is text -->
          	  ...
          	  <!-- BEGIN title_image -->
          	  <div class="row th"><img src="{left_blocks_row.title_image.TITLE}"  alt=""/></div>
          	  <!-- END title_image -->
...
<!-- RIGHT BLOCKS BEGIN -->
    ...
    <div class="col-sm-3 p-0" id="right_block" style="display: block;">
      <div class="container-fluid">
	    <div class="row">
