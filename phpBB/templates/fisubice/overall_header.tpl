...
<div class="container-fluid px-0">
  ...
  <div class="bodyline my-2" style="z-index: 1;">
    <div class="container-fluid">
	   <div class="row topbkg px-0">
		  <div class="col-4 float-left"><a href="{U_PORTAL}"><img src="templates/fisubice/images/phpbb2_logo.png" alt="{L_PORTAL}" title="{L_PORTAL}" width="240" height="110" /></a></div>
          <div class="col-8 text-center my-auto clearfix">
