...
<div class="col-sm-3 m-0 pr-0" id="header_block" style="display: ''; width:{HEADER_WIDTH}px;min-width:126px !important;">
      ...
      <div class="col px-0 align-top">
        ...
        <!-- END border -->
         ">
          ...
          <!-- BEGIN title_image -->
          <div class="row th"><img src="{header_blocks_row.title_image.TITLE}" /></div>
          <!-- END title_image -->
