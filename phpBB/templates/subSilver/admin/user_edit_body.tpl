...
<form action="{S_PROFILE_ACTION}" {S_FORM_ENCTYPE} method="post"><table width="98%" cellspacing="1" cellpadding="4" border="0" align="center" class="forumline">
	...
	<tr> 
	  <td class="row1"><span class="gen">{L_FB}&nbsp;{L_USERNAME}</span></td>
	  <td class="row2"> 
		<input class="post" type="text" name="fb" size="20" maxlength="255" value="{FB}" />
	  </td>
	</tr>
	<tr> 
	  <td class="row1"><span class="gen">{L_IG}&nbsp;{L_USERNAME}</span></td>
	  <td class="row2"> 
		<input class="post" type="text" name="ig" size="20" maxlength="255" value="{IG}" />
	  </td>
	</tr>
	<tr> 
	  <td class="row1"><span class="gen">{L_PT}&nbsp;{L_USERNAME}</span></td>
	  <td class="row2"> 
		<input class="post" type="text" name="pt" size="20" maxlength="255" value="{PT}" />
	  </td>
	</tr>
	<tr> 
