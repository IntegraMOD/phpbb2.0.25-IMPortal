...
<!-- LEFT BLOCKS BEGIN -->
    ...
    <td id="left_hide" style="display: none;" valign="top" align="left" width="10" height="18"><a href="JavaScript:ShowHide('left_block','left_hide','left_block');"><img src="{layout_collapse.LAYOUT_IMAGER}" width="10" height="18" alt="" border="0" /></a></td>
	<!-- END layout_collapse -->
	...
	<td id="left_block" style="display: ''; width:150px" valign="top">
	  <table cellpadding="0" cellspacing="0" border="0">
	    <tr>
		  ...
		  <!-- BEGIN layout_collapse -->
		  <td valign="top" style="display: block; cursor: pointer; cursor: hand;" align="left" width="10" height="18"><a href="JavaScript:ShowHide('left_block','left_hide','left_block');"><img src="{layout_collapse.LAYOUT_IMAGEL}" alt="" width="10" height="18" border="0" /></a></td>
		  <!-- END layout_collapse -->
		</tr>
	  </table>
	</td>
...
<!-- RIGHT BLOCKS BEGIN -->
	...
	<td id="right_block" style="display: ''; width:150px;" valign="top">
	  <table cellpadding="0" cellspacing="0" border="0">
	    <tr>
		<!-- BEGIN layout_collapse -->
